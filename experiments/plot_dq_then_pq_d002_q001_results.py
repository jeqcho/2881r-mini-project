#!/usr/bin/env python3
"""
Script to plot DQ-then-PQ two-stage pruning results for d=0.02, q=0.01.
...
# Data for all four models (d=0.02, q=0.01)
data = {
    'Original': {
        'zero_shot': 0.5842,
        'asr_vanilla': 0.0000,
...
def main():
    print("=" * 60)
    print("Plotting DQ-then-PQ Results for d=0.02, q=0.01")
    print("=" * 60)
    print()
    ...
    print("Generating plots for d=0.02, q=0.01...")
    print()
    ...
    create_plot(
        ...
        output_file=output_dir / 'plot_dq_then_pq_d002_q001_vanilla_asr.png',
        title='$d=0.02, q=0.01$'
    )
    ...
    create_plot(
        ...
        output_file=output_dir / 'plot_dq_then_pq_d002_q001_adv_suffix_asr.png',
        title='$d=0.02, q=0.01$'
    )
    ...
    print(f"  - {output_dir / 'plot_dq_then_pq_d002_q001_vanilla_asr.png'}")
    print(f"  - {output_dir / 'plot_dq_then_pq_d002_q001_adv_suffix_asr.png'}")
    print()
