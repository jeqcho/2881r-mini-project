#!/bin/bash
# Script to run DQ then P007Q003 two-stage pruning experiments
...
echo "=========================================="
echo "DQ then P007Q003 Two-Stage Pruning"
echo "=========================================="
echo ""
...
if [ ! -d "$SCORE_DANGER" ]; then
    ...
    echo "Please ensure danger_gcg2 SNIP scores are computed first."
    exit 1
fi
...
# D,Q pairs to run (as percentages: 0.01 = 1%)
declare -a DQ_PAIRS=(
